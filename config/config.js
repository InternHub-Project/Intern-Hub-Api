...
CONFIG.GITHUB_CLINT_ID = process.env.GITHUB_CLINT_ID
CONFIG.GITHUB_CLINT_SECRET = process.env.GITHUB_CLINT_SECRET
CONFIG.GITHUB_CALLBACK_URL = process.env.GITHUB_CALLBACK_URL
